...
// This file is the generic, content-agnostic book engine (cover/pages/backCover props).
// Unmodified from upstream — the ref-during-render pattern below is upstream's lazy-init
// for per-sheet motion values; left as-is rather than risk breaking the page-turn physics.
